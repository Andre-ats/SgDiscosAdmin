...
interface DetalhesProdutoProps {
    formatoProduto: EnumFormatoProduto | undefined;
    setFormatoProduto: (value: EnumFormatoProduto) => void;

    tipoDeAlbum: EnumTipoDeAlbum | undefined;
    setTipoDeAlbum: (value: EnumTipoDeAlbum) => void;
